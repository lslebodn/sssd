                                          ...
                                          struct sss_domain_info *domain)
{
    ...
    name = sss_get_cased_name(tmp_ctx, cr->data->svc.name->name,
                                        ...
                                        struct sss_domain_info *domain)
{
    ...
    protocol = data->svc.protocol == NULL ? "<ANY>" : data->svc.protocol;

    return talloc_asprintf(mem_ctx, "%s %s@%s", protocol,
                           data->svc.name->lookup, domain->name);
}
